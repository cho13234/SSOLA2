...
public class ThePager {
	...
	public String toString(){
		...
		if (currentPage > 1) {
			...
			linkString.append(String.format(
					"<a href='%s?pageno=%d'><img src='/ssola2/resources/images/page_left.png'></a>", linkUrl, currentPage - 1));
			linkString.append("&nbsp;");
		}
		...
		if (currentPage < pageCount) {
			...
			linkString.append(String.format(
				...
				"<a href='%s?pageno=%d'><img src='/ssola2/resources/images/page_right.png'></a>",linkUrl, currentPage + 1));
			linkString.append("&nbsp;");
			linkString.append("&nbsp;");
			linkString.append(String.format(
