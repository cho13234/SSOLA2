			...
			<form action="edit.action" method="post">
				...
				<div>
					...
					<textarea class="form-control" style='width: 100%; resize: none'
						id="editor" name="articleContent" cols="76" rows="15" >${voc.articleContent}</textarea>
				</div>
				<br/><br/><br/>
