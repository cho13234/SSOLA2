...
<body>
	...
	<div id="pageContainer">
		<div id="inputcontent">
			...
			<input type="hidden" name="articleNo" value="${freeBoard.articleNo }"/>
				<!-- title -->
				<div class="input-group">
					<span class="input-group-addon">Title</span>
					 <input class="form-control" type="text" name="articleTitle" style="width: 100%; font-family: 'Jeju Gothic', serif;"
						value="${freeBoard.articleTitle}" placeholder="게시글의 제목을 입력하세요." />
				</div>
				<br />
				<!-- id -->
				<div class="input-group">
			...
			<br/>
				...
				<div>
					...
					<textarea class="form-control" style='width: 100%; resize: none'
						id="editor" name="articleContent" cols="76" rows="15" >${freeBoard.articleContent}</textarea>
				</div>
				<br/><br/><br/>
