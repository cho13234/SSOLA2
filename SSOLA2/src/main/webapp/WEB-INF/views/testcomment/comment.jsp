					...
					<form role="form" method="post">
						<fieldset>
							<div class="form-group">
								<textarea id="commentContents" class="form-control" rows="3"
							...
							<button id="btnListComment" type="button" class="[ btn btn-default ]"
								data-loading-text="Loading..." >List</button>
								<a href = "/ssola2/comment/list.action?sectionNo=18">cs</a>
